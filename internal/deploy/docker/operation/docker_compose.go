...
type DockerCompose struct {
	description string
	composeFile string
	host        ssh.SSHConnection
	args        []string
}

func NewDockerCompose(description string, composeFile string, h ssh.SSHConnection, args []string) *DockerCompose {
...
func NewDockerComposeBuild(composeFile string, h ssh.SSHConnection) *DockerCompose {
	return NewDockerCompose("Build images", composeFile, h, []string{"build"})
}

func NewDockerComposePull(composeFile string, h ssh.SSHConnection) *DockerCompose {
	return NewDockerCompose("Pull images", composeFile, h, []string{"pull"})
}

func NewDockerComposeStop(composeFile string, h ssh.SSHConnection) *DockerCompose {
...
func NewDockerComposeUp(composeFile string, h ssh.SSHConnection, mode RecreateMode) *DockerCompose {
