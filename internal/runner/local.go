...
func (r *Local) Run(ctx context.Context, cmdStr string) (string, string, error) {
	return r.exec(ctx, cmdStr, nil)
}

func (r *Local) RunWithStdin(ctx context.Context, cmdStr string, stdin []byte) (string, string, error) {
...
func (r *Local) exec(ctx context.Context, cmdStr string, stdin []byte) (string, string, error) {
